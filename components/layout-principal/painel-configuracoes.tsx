...
import { Bell, Lock, User, Building2, Palette, Database, Shield } from "lucide-react"
          ...
          <TabsContent value="notificacoes" className="space-y-4 m-0">
            <Card className="bg-white border-none shadow-sm">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>Alertas IoT</Label>
                    <p className="text-sm text-muted-foreground">Notificar sobre eventos IoT</p>
                  </div>
                  <Switch
                    checked={notifications.iot}
                    onCheckedChange={(checked) => setNotifications({ ...notifications, iot: checked })}
                  />
                </div>
